...
var stripeModuleBtnTitle = stripeFormModule.attr("data-btn-title") || "Submit payment"
...
//var stripe = Stripe('pk_test_v4ND5Ox2C9Aypc9iIfYtc8HS00Je7Wv8AI');
...
var stripe = Stripe(pubKey);
 ...
 form.addEventListener('submit', function(event) {
   ...
   // display new btn ui
   var loadTime       = 1500
   var errorHtml      = "<i class='fa fa-warning'>An error Occured</i>"
 ...
 function  redirectingToNext(nextPath, timeOfRedirecting){
   if (nextPath){
     setTimeout(function(){
  ...
  /*  var form = document.getElementById('payment-form');
   ...
   $.ajax({
     ...
     success : function(data){
        ...
        card.clear()
        if(nextUrl){
          successMsg += "<br/><i class='fa fa-spin fa-spinner'></i>Redirecting..."
        } 
        /* else {
        ...
        redirectingToNext(nextUrl,3000)
